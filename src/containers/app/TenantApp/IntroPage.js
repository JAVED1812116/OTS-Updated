...
<Grid>
   ...
   <View style={{flex:2}}>
<Text style={{color:'#ffcc66',textAlign:'center'}}>Monthly Rent:<Text style={{color:'white',fontSize:24}}>{RentSetting.MonthlyRent}</Text></Text>
<Text style={{color:'#ffcc66',textAlign:'center'}}>Security Charges:<Text style={{color:'white',fontSize:24}}>{RentSetting.SecurityCharges}</Text></Text>
<Text style={{color:'#ffcc66',textAlign:'center'}}>Trash Charges:<Text style={{color:'white',fontSize:24}}>{RentSetting.TrashCharges}</Text></Text>
<Text style={{color:'#ffcc66',textAlign:'center'}}>Advance:<Text style={{color:'white',fontSize:24}}>{RentSetting.Advance}</Text></Text>
<Text style={{color:'#ffcc66',textAlign:'center'}}>Maintanance Charges:<Text style={{color:'white',fontSize:24}}>{RentSetting.MaintananceCharges}</Text></Text>
